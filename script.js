...
const featured = [
  ...
  'grid': 'f',
  'text': '',},
  {'image': 'img/illustration/rana_rana.png', 'piece': 'Eres mucho mas bonito q yo', 'function': 'createPage(featured[7])', 'grid': 'g',  'title': '', 'text': ''},
  {'image': 'img/illustration/paloma_portrait.png', 'function': 'createPage(featured[8])', 'piece': 'paloma paloma', 'title': '', 'grid': 'h', 'text': ''},
  {'image': 'img/senior/senior_5.png', 'function': 'createPage(featured[9])', 'piece': 'Senior Thesis Project', 'title': `<h2>"Sometimes you want to say something, and if you were a songwriter you could. But, I'm not a songwriter, so I made this."</h2>`, 'grid': 'i', 'text': '',},
